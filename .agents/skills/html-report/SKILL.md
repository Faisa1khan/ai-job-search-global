...
name: html-report
description: >-
  Generate a self-contained HTML dashboard from the application tracker and per-application archives.
---

# /html-report - Generate Application Tracker Dashboard

> Antigravity note: this skill is invoked as `/html-report`. Any text, URL or argument the
