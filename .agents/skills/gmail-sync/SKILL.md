---
name: gmail-sync
description: "Sync application status from Gmail: scan for interview invites, assessments, offers and rejections, then propose tracker updates for approval."
---

# /gmail-sync - Sync Application Status from Gmail

> Antigravity note: this skill is invoked as `/gmail-sync`. Any text, URL or argument the
