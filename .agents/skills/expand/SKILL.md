...
name: expand
description: >-
  Competency expansion from documents and public online presence. Use when the user wants to enrich their candidate profile additively.
---

# /expand - Competency Expansion from Documents and Online Presence

> Antigravity note: this skill is invoked as `/expand`. Any text, URL or argument the
