...
- **Canonical Typography Source of Truth:** `-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif` (identical to the Master resume design system).
