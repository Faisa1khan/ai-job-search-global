...
4. Read `.agents/skills/job-application-assistant/01-candidate-profile.md` to get the candidate's current skills and experience.
...
### Targeted mode
1. Use read_url_content to retrieve the job posting from the URL.
...
1. **Run a search_web** to find current, highly-rated study resources. Use queries like:
