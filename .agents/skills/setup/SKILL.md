---
name: setup
description: "Profile onboarding: collect the user's professional information and populate all profile files."
---

# /setup - Profile Onboarding

> Antigravity note: this skill is invoked as `/setup`. Any text, URL or argument the
...
### 9. Generate `.agents/skills/job-scraper/search-queries.md`
